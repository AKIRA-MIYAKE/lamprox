...
export type OnSuccessProcess<U, E> = Process<U, LambdaProxyCallbackResult, E>
/** Build callback result process when main process fail. */
export type OnFailureProcess<E> = Process<Error, LambdaProxyCallbackResult, E>
/** After process. */
export type AfterProcess<E> = Process<LambdaProxyCallbackResult, LambdaProxyCallbackResult, E>
